...
$enumProbabilitas = $data ->enum('probabilitas');
...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) { 
  ...
  $query = "INSERT INTO antrian (kategori, lokasi, tingkat, probabilitas, deskripsi) VALUES ('$kategori', '$lokasi', '$tingkat','$probabilitas', '$deskripsi')"; 
  if ($mysqli->query($query) === TRUE) {  
    echo "<script>alert('Data Berhasil Ditambahkan.'); document.location='admintask.php'</script>;";
  } else {
      ...
      <div class="main">
        <nav class="navbar navbar-expand px-4 py-3">
          ...
          <div class="navbar-collapse collapse">
            ...
            <h3 class="fw-bold fs-4 mb-3" style="color:white">Risk Register</h3>
                ...
                <form action="" method="POST" class="p-4 bg-light rounded shadow-sm">
                  ...
                  <div class="form-regis mb-3">
                    ...
                    <select name="probabilitas" id="probabilitas" required>
                      <?php foreach($enumProbabilitas as $probabilitas): ?>
                  ...
                  <a href="admindashboard.php" style="color:white">Kembali</a>
                </form>
              </div>
            </div>
          </div>
